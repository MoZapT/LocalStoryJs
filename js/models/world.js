...
class World {
    ...
    async generateLocations(templates) {
        ...
        this.locations.push(new Location(this, templates[await this.getRandomInRangeWithSeed(1, locationTemplates.length, 1231)]));
    }

    async getRandomInRangeWithSeed(min, max, seed) {
